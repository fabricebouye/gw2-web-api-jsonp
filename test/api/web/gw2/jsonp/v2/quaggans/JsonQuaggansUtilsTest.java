...
public class JsonQuaggansUtilsTest {
    ...
    @Test
    public void stream() throws IOException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchFieldException {
        ...
        try (final InputStream source = url.openStream();
            ...
            Object instance = aClass.getDeclaredConstructor()
                    .newInstance();
            String lastId = null;
            while (parser.hasNext()) {
                ...
                switch (event) {
                    ...
                    case VALUE_STRING:
                        ...
                        boolean wasAcessible = field.canAccess(instance);
